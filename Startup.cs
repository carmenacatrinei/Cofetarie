...
namespace Cofetarie
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Cofetarie", Version = "v1" });
            ...
            //dupa ce am adaugat contextul, il pot "injecta" in controller
            services.AddDbContext<CofetarieContext>(options => options
            ...
            services.AddIdentity<User, Role>()
                .AddEntityFrameworkStores<CofetarieContext>();
            ...
            //ca sa nu mai avem referinta circulara
            services.AddControllers().AddJsonOptions(x =>
            x.JsonSerializerOptions.ReferenceHandler = ReferenceHandler.Preserve);


            //o noua instanta pt fiecare clasa care care o injecteaza v
            services.AddTransient<IProductsRepository, ProductsRepository>();
            //aceeasi instanta pe toata durata request-ului v
            //services.AddScoped<IProductsRepository, ProductsRepository>();
            //o singura instanta indiferent de request v
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Cofetarie v1"));
            }
